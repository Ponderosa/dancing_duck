...
static const float MAG_OFFSET_DUCK_NUM_INDEX_X_UT[20] = {0.0, -29.20, 15.9, 0.0, -12.5, 0.0};
static const float MAG_OFFSET_DUCK_NUM_INDEX_Y_UT[20] = {0.0, -49.78, -19.6, 0.0, -20.7, 0.0};
